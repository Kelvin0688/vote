...
<br>
  ...
  <!-- Brand -->
  <a style="font-family: arial;" class="navbar-brand" >VOTING SYSTEM</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav nav-pills nav-justified">
      <li class="nav-item">
        ...
        <a class="nav-link" href="create_poll.php"><i class="fas fa-fist-raised"></i> Create A Poll </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-poll-h"></i> View Results</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-tasks"></i> Manage Poll </a>
      </li>
          <li class="nav-item">
...
<h1>Head</h1>
<h1>to</h1>
<h2>KWAME NKRUMAH UNIVERSITY OF SCIENCE AND TECHNOLOGY ELECTION</h2>
<br>
<hr>
<br>
...
<div class="footer" style="background-color: lightgreen;">
    ...
    <br>
    <center>
  <p class="foot">&copy;Copyright 2020 All rights reserved. Creativity Group. Voting System..      
