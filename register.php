    ...
    <div class="form-group">
      ...
      <fieldset >
          ...
          <p>
             ...
             <select id = "myList" class="col-lg-12 col-md-6 col-sm-6" style="font-size:20px;">
               <option value = "1">College of Education</option>
               <option value = "2">College of Science</option>
               <option value = "3">College of Agriculture and Natural Resources CANR</option>
               <option value = "4">College of Health Sciences</option>
               <option value = "5">College of Humanities and Social Sciences</option>
               <option value = "6">College of Art and Built Environment</option>
               <option value = "7">College of Engineering</option>
               <option value = "8">College of Science</option>
             </select>
          </p>
       </fieldset>
       </div>
